  ...
  <div class="w-full mt-[50px] pb-[50px] 2xl:mt-0 2xl:pb-0">
    <div class="max-w-7xl mx-auto flex flex-col justify-between">
      ...
      <div class="flex flex-col">
        ...
        <input type="file" id="pdfUpload" ref="pdfUploadRef" class="rounded-md border mt-2 mb-3 dark:bg-[#202020] dark:border-[#282828] dark:text-white file:bg-white file:border-solid file:border-[#e5e7eb] dark:file:bg-[#282828] dark:file:border-solid dark:file:border-[#383838] dark:file:text-white p-0 file:px-4 file:py-2 file:mr-4 file:border-y-0 file:border-l-0 file:shadow-none" />
      </div>
